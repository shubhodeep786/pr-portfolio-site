...
<div ref={rootRef} style={{position: 'relative', background: '#090909', color: '#f4f1ec', fontFamily: "'Space Grotesk',sans-serif", '--warm': 'oklch(0.83 0.13 66)', '--pink': 'oklch(0.8 0.14 350)', '--green': 'oklch(0.85 0.11 150)', '--txt': '#f4f1ec', '--muted': 'rgba(244,241,236,0.52)', '--line': 'rgba(244,241,236,0.1)', minHeight: '100vh', overflow: 'hidden', cursor: 'none'}}>
  ...
  <section id="skills" style={{position: 'relative', zIndex: '2', padding: 'clamp(70px,12vh,150px) clamp(20px,5vw,64px)'}}>
    ...
    <div data-reveal="" style={{opacity: '0', transform: 'translateY(34px)', transition: 'opacity .9s cubic-bezier(.2,.7,.2,1),transform .9s cubic-bezier(.2,.7,.2,1)', display: 'flex', flexWrap: 'wrap', gap: '12px', maxWidth: '1000px', marginBottom: 'clamp(28px,4vh,44px)'}} data-pills="">
      <button className="pill" data-cursor="" data-skill="Sales Navigator" data-desc="Organic growth and outreach — relevance-led messaging and campaigns that drove 250+ qualified product interactions." style={{border: '1px solid rgba(255,255,255,0.4)', borderRadius: '999px', padding: '12px 20px', fontSize: '14px', color: 'var(--txt)', background: 'rgba(255,255,255,0.1)', transition: 'transform .4s cubic-bezier(.2,.7,.2,1),background .3s,border-color .3s,color .3s'}}>Sales Navigator</button>
      ...
      <button className="pill" data-cursor="" data-skill="Email Marketing" data-desc="End-to-end email campaigns — list segmentation, copy and send-time testing built into lifecycle sequences that keep a brand top of mind." style={{border: '1px solid rgba(255,255,255,0.1)', borderRadius: '999px', padding: '12px 20px', fontSize: '14px', color: 'var(--muted)', background: 'rgba(255,255,255,0.04)', transition: 'transform .4s cubic-bezier(.2,.7,.2,1),background .3s,border-color .3s,color .3s'}}>Email Marketing</button>
      <button className="pill" data-cursor="" data-skill="Social Media Marketing" data-desc="Planning and running a brand's social presence — content calendars, community engagement and platform-native formats that build an audience over time." style={{border: '1px solid rgba(255,255,255,0.1)', borderRadius: '999px', padding: '12px 20px', fontSize: '14px', color: 'var(--muted)', background: 'rgba(255,255,255,0.04)', transition: 'transform .4s cubic-bezier(.2,.7,.2,1),background .3s,border-color .3s,color .3s'}}>Social Media Marketing</button>
    </div>
    <div data-reveal="" style={{opacity: '0', transform: 'translateY(34px)', transition: 'opacity .9s cubic-bezier(.2,.7,.2,1),transform .9s cubic-bezier(.2,.7,.2,1)', maxWidth: '760px', border: '1px solid var(--line)', borderRadius: '24px', padding: 'clamp(24px,4vw,40px)', background: 'rgba(255,255,255,0.025)', backdropFilter: 'blur(14px)'}}>
      <h3 data-skill-title="" style={{fontFamily: "'Bricolage Grotesque'", fontWeight: '700', fontSize: 'clamp(22px,3vw,32px)', letterSpacing: '-0.02em', marginBottom: '12px'}}>Sales Navigator</h3>
      <p data-skill-desc="" style={{color: 'rgba(244,241,236,0.74)', fontSize: 'clamp(15px,1.5vw,18px)', lineHeight: '1.55'}}>Organic growth and outreach — relevance-led messaging and campaigns that drove 250+ qualified product interactions.</p>
    </div>
  </section>
  ...
  <section id="work" style={{position: 'relative', zIndex: '2', padding: 'clamp(70px,12vh,150px) clamp(20px,5vw,64px)'}}>
    ...
    <div data-reveal style={{opacity: '0', transform: 'translateY(34px)', transition: 'opacity .9s cubic-bezier(.2,.7,.2,1),transform .9s cubic-bezier(.2,.7,.2,1)', marginTop: 'clamp(56px,9vh,100px)'}}>
      ...
      <div style={{display: 'flex', gap: '16px', overflowX: 'auto', paddingBottom: '12px'}}>
        ...
        <div className="tilt" style={{width: '148px', flexShrink: '0'}}><div style={{borderRadius: '16px', overflow: 'hidden', border: '1px solid var(--line)', aspectRatio: '9/16', position: 'relative'}}><img src="/assets/reels/client-onboard.jpg" alt="Client on board sales team celebration reel" loading="lazy" style={{width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /><span style={{position: 'absolute', bottom: '8px', left: '8px', fontFamily: "'JetBrains Mono'", fontSize: '11px', background: 'rgba(9,9,9,0.65)', border: '1px solid var(--line)', borderRadius: '999px', padding: '4px 9px', backdropFilter: 'blur(6px)'}}>11K views</span></div><p style={{fontSize: '12px', color: 'var(--muted)', marginTop: '8px', lineHeight: '1.3'}}>Client on board — sales team celebrates</p></div>
        <div className="tilt" style={{width: '148px', flexShrink: '0'}}><div style={{borderRadius: '16px', overflow: 'hidden', border: '1px solid var(--line)', aspectRatio: '9/16', position: 'relative'}}><img src="/assets/reels/black-screen-hook.jpg" alt="Cold-open hook frame reel" loading="lazy" style={{width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /><span style={{position: 'absolute', bottom: '8px', left: '8px', fontFamily: "'JetBrains Mono'", fontSize: '11px', background: 'rgba(9,9,9,0.65)', border: '1px solid var(--line)', borderRadius: '999px', padding: '4px 9px', backdropFilter: 'blur(6px)'}}>5,673 views</span></div><p style={{fontSize: '12px', color: 'var(--muted)', marginTop: '8px', lineHeight: '1.3'}}>A cold-open hook</p></div>
        <div className="tilt" style={{width: '148px', flexShrink: '0'}}><div style={{borderRadius: '16px', overflow: 'hidden', border: '1px solid var(--line)', aspectRatio: '9/16', position: 'relative'}}><img src="/assets/reels/ceo-voices.jpg" alt="Can our CEO get all our voices right reel" loading="lazy" style={{width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /><span style={{position: 'absolute', bottom: '8px', left: '8px', fontFamily: "'JetBrains Mono'", fontSize: '11px', background: 'rgba(9,9,9,0.65)', border: '1px solid var(--line)', borderRadius: '999px', padding: '4px 9px', backdropFilter: 'blur(6px)'}}>5,522 views</span></div><p style={{fontSize: '12px', color: 'var(--muted)', marginTop: '8px', lineHeight: '1.3'}}>Can our CEO get all our voices right?</p></div>
        <div className="tilt" style={{width: '148px', flexShrink: '0'}}><div style={{borderRadius: '16px', overflow: 'hidden', border: '1px solid var(--line)', aspectRatio: '9/16', position: 'relative'}}><img src="/assets/reels/choreo-teaching.jpg" alt="Choreo teaching steps to the team reel" loading="lazy" style={{width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /><span style={{position: 'absolute', bottom: '8px', left: '8px', fontFamily: "'JetBrains Mono'", fontSize: '11px', background: 'rgba(9,9,9,0.65)', border: '1px solid var(--line)', borderRadius: '999px', padding: '4px 9px', backdropFilter: 'blur(6px)'}}>4,901 views</span></div><p style={{fontSize: '12px', color: 'var(--muted)', marginTop: '8px', lineHeight: '1.3'}}>Choreo, teaching steps to the team</p></div>
        <div className="tilt" style={{width: '148px', flexShrink: '0'}}><div style={{borderRadius: '16px', overflow: 'hidden', border: '1px solid var(--line)', aspectRatio: '9/16', position: 'relative'}}><img src="/assets/reels/heads-stressing.jpg" alt="POV the heads stressing over event permissions reel" loading="lazy" style={{width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /><span style={{position: 'absolute', bottom: '8px', left: '8px', fontFamily: "'JetBrains Mono'", fontSize: '11px', background: 'rgba(9,9,9,0.65)', border: '1px solid var(--line)', borderRadius: '999px', padding: '4px 9px', backdropFilter: 'blur(6px)'}}>4,524 views</span></div><p style={{fontSize: '12px', color: 'var(--muted)', marginTop: '8px', lineHeight: '1.3'}}>POV: event permissions day</p></div>
        <div className="tilt" style={{width: '148px', flexShrink: '0'}}><div style={{borderRadius: '16px', overflow: 'hidden', border: '1px solid var(--line)', aspectRatio: '9/16', position: 'relative'}}><img src="/assets/reels/womens-day.jpg" alt="POV it's Women's Day Eve reel" loading="lazy" style={{width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /><span style={{position: 'absolute', bottom: '8px', left: '8px', fontFamily: "'JetBrains Mono'", fontSize: '11px', background: 'rgba(9,9,9,0.65)', border: '1px solid var(--line)', borderRadius: '999px', padding: '4px 9px', backdropFilter: 'blur(6px)'}}>4,048 views</span></div><p style={{fontSize: '12px', color: 'var(--muted)', marginTop: '8px', lineHeight: '1.3'}}>POV: Women's Day eve</p></div>
        <div className="tilt" style={{width: '148px', flexShrink: '0'}}><div style={{borderRadius: '16px', overflow: 'hidden', border: '1px solid var(--line)', aspectRatio: '9/16', position: 'relative'}}><img src="/assets/reels/internship-journey.jpg" alt="The Internship Journey Part 1 reel" loading="lazy" style={{width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /><span style={{position: 'absolute', bottom: '8px', left: '8px', fontFamily: "'JetBrains Mono'", fontSize: '11px', background: 'rgba(9,9,9,0.65)', border: '1px solid var(--line)', borderRadius: '999px', padding: '4px 9px', backdropFilter: 'blur(6px)'}}>3,410 views</span></div><p style={{fontSize: '12px', color: 'var(--muted)', marginTop: '8px', lineHeight: '1.3'}}>The internship journey, part 1</p></div>
        <div className="tilt" style={{width: '148px', flexShrink: '0'}}><div style={{borderRadius: '16px', overflow: 'hidden', border: '1px solid var(--line)', aspectRatio: '9/16', position: 'relative'}}><img src="/assets/reels/radhika-travel.jpg" alt="Team culture reel — Radhika on travel" loading="lazy" style={{width: '100%', height: '100%', objectFit: 'cover', display: 'block'}} /><span style={{position: 'absolute', bottom: '8px', left: '8px', fontFamily: "'JetBrains Mono'", fontSize: '11px', background: 'rgba(9,9,9,0.65)', border: '1px solid var(--line)', borderRadius: '999px', padding: '4px 9px', backdropFilter: 'blur(6px)'}}>3,389 views</span></div><p style={{fontSize: '12px', color: 'var(--muted)', marginTop: '8px', lineHeight: '1.3'}}>Asking the team why they work</p></div>
      </div>
    </div>
  </section>
  ...
  <section id="contact" style={{position: 'relative', zIndex: '2', padding: 'clamp(90px,16vh,200px) clamp(20px,5vw,64px) clamp(50px,8vh,90px)', textAlign: 'center', overflow: 'hidden'}}>
    ...
    <div data-reveal="" data-delay="120" style={{opacity: '0', transform: 'translateY(34px)', transition: 'opacity 1s cubic-bezier(.2,.7,.2,1),transform 1s cubic-bezier(.2,.7,.2,1)', display: 'flex', flexWrap: 'wrap', gap: '16px', justifyContent: 'center', marginTop: 'clamp(40px,7vh,70px)'}}>
      <a className="magnetic" data-cursor="" href="https://mail.google.com/mail/?view=cm&fs=1&to=payalraut0805@gmail.com" target="_blank" rel="noopener" style={{position: 'relative', border: '1px solid rgba(255,255,255,0.5)', borderRadius: '999px', padding: '18px 34px', fontSize: '15px', display: 'inline-flex', alignItems: 'center', gap: '10px', background: 'rgba(255,255,255,0.06)', backdropFilter: 'blur(10px)', transition: 'background .3s,border-color .3s'}}><span className="magnetic-inner" style={{display: 'inline-block'}}>Email</span></a>
