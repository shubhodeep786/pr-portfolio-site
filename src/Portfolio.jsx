...
const SKILLS = [
  ...
  { name: "Content", desc: "Planning content that maps to product positioning, using calendars, blogs and social built around a real audience need." },
...
const SOCIAL = [
  ...
  { src: "/assets/social/track-progress.jpg", alt: "Track your progress and turn effort into results, app promo", caption: "Product feature carousel" },
];
